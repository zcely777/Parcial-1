...
def process_html():
    """Procesa los archivos HTML de S3, extrae datos y guarda un CSV en S3."""
    s3 = boto3.client("s3")
    ...
    for file_key in files:
        ...
        for prop in properties:
            try:
                ...
                print(f"⚠️ Error procesando propiedad en {file_key}: {str(e)}")
                continue
    ...
    csv_header = "FechaDescarga,Barrio,Valor,NumHabitaciones,NumBanos,mts2\n"
